...
HelpFormatter.prototype._splitLines = function (text, width) {
  var lines = [];
  var ecf_miters = [" ", ".", ",", "!", "?"];
  var re = new RegExp('[' + ecf_miters.join('') + '][^' + ecf_miters.join('') + ']*$');
  ...
  text.split($$.EOL).forEach(function (line) {
    ...
    var wrapStart = 0;
    var wrapEnd = width;
    var ecf_miterIndex = 0;
    while (wrapEnd <= line.length) {
      if (wrapEnd !== line.length && ecf_miters.indexOf(line[wrapEnd] < -1)) {
        ecf_miterIndex = (re.exec(line.substring(wrapStart, wrapEnd)) || {}).index;
        wrapEnd = wrapStart + ecf_miterIndex + 1;
      }
