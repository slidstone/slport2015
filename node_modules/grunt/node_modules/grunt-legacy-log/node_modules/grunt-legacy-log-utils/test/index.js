...
exports['Helpers'] = {
  ...
  'wraptext': function(test) {
    ...
    // doAll(text);
    // text = 'foolish '.red.inverse + 'monkeys'.yellow + ' eating'.green + ' ' + 'ecf_cious'.inverse.blue + ' bananas '.magenta + 'forever'.red;
    // doAll(text);
    // text = 'foolish monkeys eating ecf_cious bananas forever'.rainbow;
    // doAll(text);
